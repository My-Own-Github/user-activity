...
class Login extends React.Component {
    ...
    render() {
        return (
            <div className={"container register-shop-container mt-3 mb-3"}>
                {!this.state.showRegSuccessMsg &&
                    <div className="card  shadow-lg  bg-white rounded-lg">
                        <div className="row justify-content-center align-items-center">
                            <div className="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 loginbgPic">
                            ...
                            <div className="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                <Card.Body className="mb-0">
                                    <Card.Title className="text-center"><strong>Let's Get Started</strong></Card.Title>
                                    <Form noValidate validated={this.state.formValid} onSubmit={this.handleSubmit}>
                                        ...
                                        <div className="row mt-3 justify-content-center">
                                            <div className="col-6 text-center">
                                                <Button type="submit" className="btn btn-secondary btn-block text-white" onClick={this.goToDashboard}>SIGN IN</Button>
                                            </div>
                                        </div>
                                    </Form>
                                </Card.Body>
